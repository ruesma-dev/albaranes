...
Resumen: **20 features**, 16 abiertas, 4 terminadas.
...
| F-016 | Reparto de una línea del albarán entre varias partidas | 3 | pendiente | estandar | `feature/F-016-linea-multipartida` |
| F-020 | El pipeline es agnóstico al proveedor de IA: ninguna fase privilegia a OpenAI | 4 | pendiente | estandar | `feature/F-020-proveedor-agnostico` |
| F-003 | Tanda 2 — Albaranes valorados, match estricto y coherencia (G3+G4+G5) | 5 | spec lista | estandar | `feature/F-003-valorados-match-estricto` |
| F-014 | Conversor del formato plano del administrativo a fixtures de evals | 5 | pendiente | estandar | `feature/F-014-conversor-administrativo` |
| F-018 | Carga incompleta: línea siempre generada por IA2 y cantidad fijada por IA3 con mínimo por defecto 6 m³ | 7 | pendiente | estandar | `feature/F-018-carga-incompleta` |
| F-004 | Tanda 3 — Hormigón fino y veto de mortero | 8 | spec lista | estandar | `feature/F-004-hormigon-fino` |
| F-005 | Tanda 4a — Tipología bombeo | 9 | spec lista | estandar | `feature/F-005-bombeo` |
| F-006 | Tanda 4b — Residuos: lógica de pago LLEVAR/RETIRAR y canon | 10 | spec lista | estandar | `feature/F-006-residuos-pago` |
| F-007 | Tanda 5 — Partida ALM por defecto y selector de candidatas en sv4 | 11 | spec lista | estandar | `feature/F-007-partida-alm-selector` |
| F-017 | El comparativo como fuente de precio (1c) en la valoración | 12 | pendiente | estandar | `feature/F-017-comparativo-precio` |
...
estado **pendiente** · prioridad 3 · rigor `estandar` · SDD sí · rama `feature/F-016-linea-multipartida`
...
estado **pendiente** · prioridad 4 · rigor `estandar` · SDD sí · rama `feature/F-020-proveedor-agnostico`
...
estado **spec lista** · prioridad 5 · rigor `estandar` · SDD sí · rama `feature/F-003-valorados-match-estricto`
...
estado **pendiente** · prioridad 5 · rigor `estandar` · SDD sí · rama `feature/F-014-conversor-administrativo`
...
estado **pendiente** · prioridad 7 · rigor `estandar` · SDD sí · rama `feature/F-018-carga-incompleta`
...
estado **spec lista** · prioridad 8 · rigor `estandar` · SDD sí · rama `feature/F-004-hormigon-fino`
...
estado **spec lista** · prioridad 9 · rigor `estandar` · SDD sí · rama `feature/F-005-bombeo`
...
estado **spec lista** · prioridad 10 · rigor `estandar` · SDD sí · rama `feature/F-006-residuos-pago`
...
estado **spec lista** · prioridad 11 · rigor `estandar` · SDD sí · rama `feature/F-007-partida-alm-selector`
...
estado **pendiente** · prioridad 12 · rigor `estandar` · SDD sí · rama `feature/F-017-comparativo-precio`
