...
Resumen: **35 features**, 29 abiertas, 6 terminadas.
...
| F-030 | IA2 busca el proveedor parecido cuando el CIF leído no casa con ninguno de Sigrid | 6 | pendiente | estandar | `feature/F-030-proveedor-cif-aproximado` |
| F-031 | La partida del albarán no se usa para elegir la línea de contrato cuando la descripción no coincide | 7 | pendiente | estandar | `feature/F-031-partida-elige-linea-contrato` |
| F-032 | precio_neto no tiene semántica única y genera line_net_mismatch masivo | 8 | pendiente | estandar | `feature/F-032-semantica-precio-neto` |
| F-033 | El contrato llega a sv5 en Markdown o en PDF según el documento, sin criterio determinista | 9 | pendiente | estandar | `feature/F-033-contrato-md-o-pdf-determinista` |
| F-023 | Mortero: las sintéticas de contrato no se emiten porque IA3 y sv6 las vetan por tipo_familia | 10 | pendiente | critico | `feature/F-023-mortero-incrementos` |
| F-015 | Líneas tachadas del albarán: no se registran | 11 | pendiente | estandar | `feature/F-015-lineas-tachadas` |
| F-021 | Partida: validación contra el catálogo del contrato y elección asistida entre candidatas | 12 | pendiente | estandar | `feature/F-021-partida-catalogo-candidatas` |
| F-016 | Reparto de una línea del albarán entre varias partidas | 13 | pendiente | estandar | `feature/F-016-linea-multipartida` |
...
estado **pendiente** · prioridad 3 · rigor `estandar` · SDD sí · rama `feature/F-024-unidad-medida`
...
estado **pendiente** · prioridad 4 · rigor `critico` · SDD sí · rama `feature/F-028-selector-contrato-por-partidas`
...
estado **pendiente** · prioridad 5 · rigor `critico` · SDD sí · rama `feature/F-029-obra-empates-y-sin-cif`
...
estado **pendiente** · prioridad 6 · rigor `estandar` · SDD sí · rama `feature/F-030-proveedor-cif-aproximado`
...
estado **pendiente** · prioridad 7 · rigor `estandar` · SDD sí · rama `feature/F-031-partida-elige-linea-contrato`
...
estado **pendiente** · prioridad 8 · rigor `estandar` · SDD sí · rama `feature/F-032-semantica-precio-neto`
...
estado **pendiente** · prioridad 9 · rigor `estandar` · SDD sí · rama `feature/F-033-contrato-md-o-pdf-determinista`
...
estado **pendiente** · prioridad 10 · rigor `critico` · SDD sí · rama `feature/F-023-mortero-incrementos`
...
estado **pendiente** · prioridad 11 · rigor `estandar` · SDD sí · rama `feature/F-015-lineas-tachadas`
...
estado **pendiente** · prioridad 12 · rigor `estandar` · SDD sí · rama `feature/F-021-partida-catalogo-candidatas`
...
estado **pendiente** · prioridad 13 · rigor `estandar` · SDD sí · rama `feature/F-016-linea-multipartida`
