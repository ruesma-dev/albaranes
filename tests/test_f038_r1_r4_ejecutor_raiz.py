# tests/test_f038_r1_r4_ejecutor_raiz.py
"""F-038 · R1–R4: la campaña puede juzgar lo que no pertenece a un servicio.
...
def test_f038_r1_lo_que_no_es_de_un_servicio_se_acota_a_tests(tmp_path: Path) -> None:
...
def test_f038_r1_un_py_de_un_servicio_de_otro_lenguaje_tambien_se_acota(
    tmp_path: Path,
) -> None:
...
def test_f038_r2_sin_directorio_tests_la_invocacion_es_la_de_siempre(
    tmp_path: Path,
) -> None:
...
def test_f038_r1_el_fichero_de_un_servicio_python_no_lleva_ruta(tmp_path: Path) -> None:
...
def test_f038_r1_la_ruta_acotada_llega_a_la_orden_de_pytest(
...
def test_f038_r3_la_linea_base_corre_con_la_misma_ruta_acotada(
    tmp_path: Path, espia: _EspiaSubprocess
) -> None:
...
def test_f038_r3_sin_ruta_la_orden_no_gana_argumentos(
    tmp_path: Path, espia: _EspiaSubprocess
) -> None:
...
def test_f038_r4_la_identidad_distingue_dos_rutas_acotadas(tmp_path: Path) -> None:
...
def test_f038_r4_dos_ejecutores_identicos_siguen_compartiendo_identidad(
    tmp_path: Path,
) -> None:
...
def test_f038_r4_los_implicados_no_funden_la_raiz_acotada_con_la_libre(
    tmp_path: Path,
) -> None:
