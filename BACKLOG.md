...
|---|---|---|---|---|---|
| F-039 | Arnes: estabilizar la suite de la raiz y remedir las campanas juzgadas con la invocacion rota | 2 | en curso | estandar | `feature/F-039-remedir-campanas-invocacion-rota` |
...
estado **en curso** · prioridad 2 · rigor `estandar` · SDD sí · rama `feature/F-039-remedir-campanas-invocacion-rota`
