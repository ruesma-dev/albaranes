...
- [ ] T11: `albaranes.py`: normalización del código y emparejado caso <-> documento admitiendo `.pdf`, `.png`, `.jpg` y `.jpeg`, con la lista de huérfanos y ambiguos.  |  Verificación: `pytest tests/test_f045_r20_r21_albaranes.py` (R20, R21: nada asume `.pdf`)
