...
|---|---|---|---|---|---|
| F-034 | Arnés: la mutación no muta `is`/`is not`, y dos incoherencias que la puerta de evals arrastra | 1 | bloqueada | estandar | `feature/F-034-mutacion-is-y-coherencia-evals` |
...
| F-024 | La unidad de medida no se extrae: unidad_medida NULL en las líneas base de hormigón y mortero | 5 | pendiente | estandar | `feature/F-024-unidad-medida` |
| F-028 | Con dos contratos candidatos no se elige ninguno y el albarán no llega a valorarse | 6 | pendiente | critico | `feature/F-028-selector-contrato-por-partidas` |
| F-029 | Obra resuelta por texto sin detectar empates: score 1,00 a la obra equivocada | 7 | pendiente | critico | `feature/F-029-obra-empates-y-sin-cif` |
| F-030 | IA2 busca el proveedor parecido cuando el CIF leído no casa con ninguno de Sigrid | 8 | pendiente | estandar | `feature/F-030-proveedor-cif-aproximado` |
| F-031 | La partida del albarán no se usa para elegir la línea de contrato cuando la descripción no coincide | 9 | pendiente | estandar | `feature/F-031-partida-elige-linea-contrato` |
| F-032 | precio_neto no tiene semántica única y genera line_net_mismatch masivo | 10 | pendiente | estandar | `feature/F-032-semantica-precio-neto` |
| F-033 | El contrato llega a sv5 en Markdown o en PDF según el documento, sin criterio determinista | 11 | pendiente | estandar | `feature/F-033-contrato-md-o-pdf-determinista` |
| F-023 | Mortero: las sintéticas de contrato no se emiten porque IA3 y sv6 las vetan por tipo_familia | 12 | pendiente | critico | `feature/F-023-mortero-incrementos` |
| F-015 | Líneas tachadas del albarán: no se registran | 13 | pendiente | estandar | `feature/F-015-lineas-tachadas` |
| F-021 | Partida: validación contra el catálogo del contrato y elección asistida entre candidatas | 14 | pendiente | estandar | `feature/F-021-partida-catalogo-candidatas` |
| F-016 | Reparto de una línea del albarán entre varias partidas | 15 | pendiente | estandar | `feature/F-016-linea-multipartida` |
| F-026 | Guard de partida de la línea BASE antes de escribir en contrato_lines_derived | 16 | pendiente | estandar | `feature/F-026-guard-partida-base` |
| F-025 | El motivo no_quantity_in_albaran es una falsa alarma sistemática cuando se omite la conversión de unidad | 17 | pendiente | estandar | `feature/F-025-motivo-conversion-omitida` |
| F-020 | El pipeline es agnóstico al proveedor de IA: ninguna fase privilegia a OpenAI | 18 | pendiente | estandar | `feature/F-020-proveedor-agnostico` |
| F-003 | Tanda 2 — Albaranes valorados, match estricto y coherencia (G3+G4+G5) | 19 | spec lista | estandar | `feature/F-003-valorados-match-estricto` |
| F-014 | Conversor del formato plano del administrativo a fixtures de evals | 20 | pendiente | estandar | `feature/F-014-conversor-administrativo` |
| F-018 | Carga incompleta: línea siempre generada por IA2 y cantidad fijada por IA3 con mínimo por defecto 6 m³ | 21 | pendiente | estandar | `feature/F-018-carga-incompleta` |
| F-004 | Tanda 3 — Hormigón fino y veto de mortero | 22 | spec lista | estandar | `feature/F-004-hormigon-fino` |
| F-005 | Tanda 4a — Tipología bombeo | 23 | spec lista | estandar | `feature/F-005-bombeo` |
| F-006 | Tanda 4b — Residuos: lógica de pago LLEVAR/RETIRAR y canon | 24 | spec lista | estandar | `feature/F-006-residuos-pago` |
| F-007 | Tanda 5 — Partida ALM por defecto y selector de candidatas en sv4 | 25 | spec lista | estandar | `feature/F-007-partida-alm-selector` |
| F-017 | El comparativo como fuente de precio (1c) en la valoración | 26 | pendiente | estandar | `feature/F-017-comparativo-precio` |
| F-013 | Registro del albarán aprobado en Sigrid (consumidor de q-feedback) | 27 | pendiente | critico | `feature/F-013-registro-sigrid` |
| F-008 | Lifecycle de blobs de hand-off | 28 | pendiente | estandar | `feature/F-008-blob-lifecycle` |
| F-009 | Limpieza de la cola huérfana q-emails | 29 | pendiente | estandar | `feature/F-009-limpieza-q-emails` |
| F-010 | Easy Auth en el portal sv4 | 30 | pendiente | critico | `feature/F-010-easy-auth-sv4` |
| F-022 | Bandeja de portada: el concepto de las líneas del albarán sale vacío porque el JOIN de la línea derivada apunta a la tabla equivocada | 31 | pendiente | estandar | `feature/F-022-concepto-lineas-bandeja` |
...
estado **bloqueada** · prioridad 1 · rigor `estandar` · SDD sí · rama `feature/F-034-mutacion-is-y-coherencia-evals`
...
estado **pendiente** · prioridad 3 · rigor `critico` · SDD sí · rama `feature/F-036-residuos-contenedores-e-incrementos`
...
estado **pendiente** · prioridad 4 · rigor `estandar` · SDD sí · rama `feature/F-037-guardado-inmediato-contrato`
...
estado **pendiente** · prioridad 5 · rigor `estandar` · SDD sí · rama `feature/F-024-unidad-medida`
...
estado **pendiente** · prioridad 6 · rigor `critico` · SDD sí · rama `feature/F-028-selector-contrato-por-partidas`
...
estado **pendiente** · prioridad 7 · rigor `critico` · SDD sí · rama `feature/F-029-obra-empates-y-sin-cif`
...
estado **pendiente** · prioridad 8 · rigor `estandar` · SDD sí · rama `feature/F-030-proveedor-cif-aproximado`
...
estado **pendiente** · prioridad 9 · rigor `estandar` · SDD sí · rama `feature/F-031-partida-elige-linea-contrato`
...
estado **pendiente** · prioridad 10 · rigor `estandar` · SDD sí · rama `feature/F-032-semantica-precio-neto`
...
estado **pendiente** · prioridad 11 · rigor `estandar` · SDD sí · rama `feature/F-033-contrato-md-o-pdf-determinista`
...
estado **pendiente** · prioridad 12 · rigor `critico` · SDD sí · rama `feature/F-023-mortero-incrementos`
...
estado **pendiente** · prioridad 13 · rigor `estandar` · SDD sí · rama `feature/F-015-lineas-tachadas`
...
estado **pendiente** · prioridad 14 · rigor `estandar` · SDD sí · rama `feature/F-021-partida-catalogo-candidatas`
...
estado **pendiente** · prioridad 15 · rigor `estandar` · SDD sí · rama `feature/F-016-linea-multipartida`
...
estado **pendiente** · prioridad 16 · rigor `estandar` · SDD sí · rama `feature/F-026-guard-partida-base`
...
estado **pendiente** · prioridad 17 · rigor `estandar` · SDD sí · rama `feature/F-025-motivo-conversion-omitida`
...
estado **pendiente** · prioridad 18 · rigor `estandar` · SDD sí · rama `feature/F-020-proveedor-agnostico`
...
estado **spec lista** · prioridad 19 · rigor `estandar` · SDD sí · rama `feature/F-003-valorados-match-estricto`
...
estado **pendiente** · prioridad 20 · rigor `estandar` · SDD sí · rama `feature/F-014-conversor-administrativo`
...
estado **pendiente** · prioridad 21 · rigor `estandar` · SDD sí · rama `feature/F-018-carga-incompleta`
...
estado **spec lista** · prioridad 22 · rigor `estandar` · SDD sí · rama `feature/F-004-hormigon-fino`
...
estado **spec lista** · prioridad 23 · rigor `estandar` · SDD sí · rama `feature/F-005-bombeo`
...
estado **spec lista** · prioridad 24 · rigor `estandar` · SDD sí · rama `feature/F-006-residuos-pago`
...
estado **spec lista** · prioridad 25 · rigor `estandar` · SDD sí · rama `feature/F-007-partida-alm-selector`
...
estado **pendiente** · prioridad 26 · rigor `estandar` · SDD sí · rama `feature/F-017-comparativo-precio`
...
estado **pendiente** · prioridad 27 · rigor `critico` · SDD sí · rama `feature/F-013-registro-sigrid`
...
estado **pendiente** · prioridad 28 · rigor `estandar` · SDD no · rama `feature/F-008-blob-lifecycle`
...
estado **pendiente** · prioridad 29 · rigor `estandar` · SDD no · rama `feature/F-009-limpieza-q-emails`
...
estado **pendiente** · prioridad 30 · rigor `critico` · SDD sí · rama `feature/F-010-easy-auth-sv4`
...
estado **pendiente** · prioridad 31 · rigor `estandar` · SDD sí · rama `feature/F-022-concepto-lineas-bandeja`
