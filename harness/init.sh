...
# mutante, no el código, y su rojo no significa nada. Pasó el 2026-08-19 y el
# 20: un agente lanzó init.sh mientras otro tenía una campaña corriendo, y
# durante 63 minutos harness/mutacion.py tuvo mutantes escritos en el fichero
# de verdad sin que nada lo avisara.
#
