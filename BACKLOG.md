...
Resumen: **26 features**, 22 abiertas, 4 terminadas.
...
| F-023 | Mortero: las sintéticas de contrato no se emiten porque IA3 y sv6 las vetan por tipo_familia | 2 | pendiente | critico | `feature/F-023-mortero-incrementos` |
| F-015 | Líneas tachadas del albarán: no se registran | 3 | pendiente | estandar | `feature/F-015-lineas-tachadas` |
| F-021 | Partida: validación contra el catálogo del contrato y elección asistida entre candidatas | 4 | pendiente | estandar | `feature/F-021-partida-catalogo-candidatas` |
| F-016 | Reparto de una línea del albarán entre varias partidas | 5 | pendiente | estandar | `feature/F-016-linea-multipartida` |
...
| F-026 | Guard de partida de la línea BASE antes de escribir en contrato_lines_derived | 7 | pendiente | estandar | `feature/F-026-guard-partida-base` |
| F-025 | El motivo no_quantity_in_albaran es una falsa alarma sistemática cuando se omite la conversión de unidad | 8 | pendiente | estandar | `feature/F-025-motivo-conversion-omitida` |
| F-020 | El pipeline es agnóstico al proveedor de IA: ninguna fase privilegia a OpenAI | 9 | pendiente | estandar | `feature/F-020-proveedor-agnostico` |
| F-003 | Tanda 2 — Albaranes valorados, match estricto y coherencia (G3+G4+G5) | 10 | spec lista | estandar | `feature/F-003-valorados-match-estricto` |
| F-014 | Conversor del formato plano del administrativo a fixtures de evals | 11 | pendiente | estandar | `feature/F-014-conversor-administrativo` |
| F-018 | Carga incompleta: línea siempre generada por IA2 y cantidad fijada por IA3 con mínimo por defecto 6 m³ | 12 | pendiente | estandar | `feature/F-018-carga-incompleta` |
| F-004 | Tanda 3 — Hormigón fino y veto de mortero | 13 | spec lista | estandar | `feature/F-004-hormigon-fino` |
| F-005 | Tanda 4a — Tipología bombeo | 14 | spec lista | estandar | `feature/F-005-bombeo` |
| F-006 | Tanda 4b — Residuos: lógica de pago LLEVAR/RETIRAR y canon | 15 | spec lista | estandar | `feature/F-006-residuos-pago` |
| F-007 | Tanda 5 — Partida ALM por defecto y selector de candidatas en sv4 | 16 | spec lista | estandar | `feature/F-007-partida-alm-selector` |
| F-017 | El comparativo como fuente de precio (1c) en la valoración | 17 | pendiente | estandar | `feature/F-017-comparativo-precio` |
| F-013 | Registro del albarán aprobado en Sigrid (consumidor de q-feedback) | 18 | pendiente | critico | `feature/F-013-registro-sigrid` |
| F-008 | Lifecycle de blobs de hand-off | 19 | pendiente | estandar | `feature/F-008-blob-lifecycle` |
| F-009 | Limpieza de la cola huérfana q-emails | 20 | pendiente | estandar | `feature/F-009-limpieza-q-emails` |
| F-010 | Easy Auth en el portal sv4 | 21 | pendiente | critico | `feature/F-010-easy-auth-sv4` |
| F-022 | Bandeja de portada: el concepto de las líneas del albarán sale vacío porque el JOIN de la línea derivada apunta a la tabla equivocada | 22 | pendiente | estandar | `feature/F-022-concepto-lineas-bandeja` |
...
estado **pendiente** · prioridad 2 · rigor `critico` · SDD sí · rama `feature/F-023-mortero-incrementos`
...
estado **pendiente** · prioridad 3 · rigor `estandar` · SDD sí · rama `feature/F-015-lineas-tachadas`
...
estado **pendiente** · prioridad 4 · rigor `estandar` · SDD sí · rama `feature/F-021-partida-catalogo-candidatas`
...
estado **pendiente** · prioridad 5 · rigor `estandar` · SDD sí · rama `feature/F-016-linea-multipartida`
...
estado **pendiente** · prioridad 7 · rigor `estandar` · SDD sí · rama `feature/F-026-guard-partida-base`
...
estado **pendiente** · prioridad 8 · rigor `estandar` · SDD sí · rama `feature/F-025-motivo-conversion-omitida`
...
estado **pendiente** · prioridad 9 · rigor `estandar` · SDD sí · rama `feature/F-020-proveedor-agnostico`
...
estado **spec lista** · prioridad 10 · rigor `estandar` · SDD sí · rama `feature/F-003-valorados-match-estricto`
...
estado **pendiente** · prioridad 11 · rigor `estandar` · SDD sí · rama `feature/F-014-conversor-administrativo`
...
estado **pendiente** · prioridad 12 · rigor `estandar` · SDD sí · rama `feature/F-018-carga-incompleta`
...
estado **spec lista** · prioridad 13 · rigor `estandar` · SDD sí · rama `feature/F-004-hormigon-fino`
...
estado **spec lista** · prioridad 14 · rigor `estandar` · SDD sí · rama `feature/F-005-bombeo`
...
estado **spec lista** · prioridad 15 · rigor `estandar` · SDD sí · rama `feature/F-006-residuos-pago`
...
estado **spec lista** · prioridad 16 · rigor `estandar` · SDD sí · rama `feature/F-007-partida-alm-selector`
...
estado **pendiente** · prioridad 17 · rigor `estandar` · SDD sí · rama `feature/F-017-comparativo-precio`
...
estado **pendiente** · prioridad 18 · rigor `critico` · SDD sí · rama `feature/F-013-registro-sigrid`
...
estado **pendiente** · prioridad 19 · rigor `estandar` · SDD no · rama `feature/F-008-blob-lifecycle`
...
estado **pendiente** · prioridad 20 · rigor `estandar` · SDD no · rama `feature/F-009-limpieza-q-emails`
...
estado **pendiente** · prioridad 21 · rigor `critico` · SDD sí · rama `feature/F-010-easy-auth-sv4`
...
estado **pendiente** · prioridad 22 · rigor `estandar` · SDD sí · rama `feature/F-022-concepto-lineas-bandeja`
